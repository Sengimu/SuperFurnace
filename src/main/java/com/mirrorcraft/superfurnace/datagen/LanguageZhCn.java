...
public class LanguageZhCn extends LanguageProvider {
    ...
    protected void addTranslations() {
        add("message.superfurnace.welcome", "欢迎游玩MOD");
        add("message.superfurnace.counter.success", "恭喜中奖,号码: %d");
        add("message.superfurnace.counter.fail", "计数: %d");
